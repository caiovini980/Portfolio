...
import PortfolioItem from "../components/old/PortfolioItem";
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="col-span-1 grid grid-row-3 w-auto h-auto text-wrap">
                                    ...
                                    <div className="row-start-2 row-end-2">
                                        ...
                                        <p className="text-2xl leading-relaxed font-semibold line pb-5 text-stone-800 dark:text-stone-100">
                                            Hi! I'm Caio, a
                                            <span className="inline-block font-bold bg-gradient-to-tr from-violet-600 to-amber-400 bg-clip-text text-transparent pr-2 pl-2">
                                                software engineer
                                            </span>
                                            <br />
                                            <span className="">
                                ...
                                <div className="col-span-1 flex justify-center items-center">
                                    ...
                                    <img 
                                        ...
                                        src="../assets/images/profile-alt.jpg" 
